    ...
    <div>
      <Card className={classes.card}>
        ...
        <div className={classes.notthumb}>
          ...
          <CardActions>
            <Button size="small" color="primary" className={classes.root} onClick={handleClickOpen('paper')}>
              View Project
                    </Button>
          </CardActions></div>
      </Card>
      ...
      >
        <DialogTitle
          ...
          {props.projectTitle}</DialogTitle>
        <DialogContent dividers={scroll === 'paper'} className={classes.content}>
            ...
            <div className={classes.rootexp}>
              <ExpansionPanel>
                <ExpansionPanelSummary
                  ...
                  id="panel1a-header"
                >
                  <Typography className={classes.default}>Project Members</Typography>
                </ExpansionPanelSummary>
                  ...
                  <Grid container justify="center" alignItems="center" >
                    {
                      props.projectMembers.map(send =>
                        props.spiderMembers.map(key => {
                          ...
                          if (send === key.Name) {
                            link = key.Photo;
                            return (<div className={classes.member}><center>
                              <Avatar alt="Member" src={link} className={classes.bigAvatar} />
                              <typography className={classes.root}>{send}</typography>
                            </center>
                            </div>
                            )
                          }
              ...
              <ExpansionPanel>
                <ExpansionPanelSummary
                  ...
                  id="panel2a-header"
                >
                  <Typography className={classes.default}>Project Media</Typography>
                </ExpansionPanelSummary>
                <ExpansionPanelDetails>
        ...
        <DialogActions className={classes.dialog}>
          <Button onClick={handleClose} color="primary" className={classes.dialog}>
            Close
                    </Button>
        </DialogActions>
      </Dialog>
              ...
              <Grid container spacing={2} justify="center">
                <Grid item>
                  <div className={classes.logos}>
                    ...
                    <center><typography className={classes.default}>App Dev</typography>
                    </center>
                  </div>
                </Grid>
                <Grid item>
                  <div className={classes.logos}>
                    ...
                    <center><typography className={classes.default}>Web Dev</typography>
                    </center>
                  </div>
                </Grid>
                <Grid item>
                  <div className={classes.logos}>
                    ...
                    <center><typography className={classes.default}>Tronix</typography>
                    </center>
                  </div>
                </Grid>
                <Grid item>
                  <div className={classes.logos}>
                    ...
                    <center><typography className={classes.default}>Algos</typography>
                    </center>
                  </div>
                </Grid>
              </Grid>
